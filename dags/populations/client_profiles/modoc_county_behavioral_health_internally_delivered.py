...
class ModocCountyBehavioralHealthInternallyDeliveredClientProfile(ClientProfile):
    ...
    def _get_mpis_for_dataframe(self, df, connection):
        ...
        for i, row in df.iterrows():
            ...
            dob = datetime.datetime.strptime(str(row['Alias_4']), "%m/%d/%Y").strftime("%Y%m%d")  # '19960801'
