...
class YoloHospiceIncInternallyDeliveredClientProfile(ClientProfile):
    ...
    def _get_dataframe(self):
        return pd.read_csv(self.input_file_path, skiprows=1) ### Change to read_excel when this is available ### 
