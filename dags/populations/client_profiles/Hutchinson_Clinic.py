...
#Hutchinson_Clinic = ClientProfile(name = "Hutchinson Clinic")
class Hutchinson_Clinic(ClientProfile):
    def __init__(self):
        super().__init__()
        self._client_name = "Hutchinson Clinic"
    ...
    def _query_and_insert_mpi(self, facility_ids):
        ...
        quoted_values = ', '.join([f"'{value}'" for value in facility_ids.split(',')])
