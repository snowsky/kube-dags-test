...
transfer_tasks = CustomPythonOperator.partial(
        task_id='transfer_batch_to_sftp',
        python_callable=transfer_batch_to_sftp,
        execution_timeout=timedelta(minutes=60)  # Set timeout for each mapped task to 60 minutes
