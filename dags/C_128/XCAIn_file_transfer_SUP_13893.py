...
#CCDA_DIR = "/data/biakonzasftp/C-128/archive/XCAIn_AA"
...
files >> xml_files >> batches >> transfer_tasks >> delete_empty_directories_from_s3_end >> local_files >> process_local_files
