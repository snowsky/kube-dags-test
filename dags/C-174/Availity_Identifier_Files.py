...
DEFAULT_SOURCE_FILES_DIRECTORY = '/source-biakonzasftp/C-174/'#Dev'/data/biakonzasftp/C-174/Availity/UnZipped/' 
DEFAULT_DEST_FILES_DIRECTORY = '/source-biakonzasftp/C-194/archive_C-174/' #dev'/data/biakonzasftp/C-194/C-174/dest/'
