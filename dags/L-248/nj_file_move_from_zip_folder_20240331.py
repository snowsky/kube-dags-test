...
dag = DAG(
    'nj_file_move_from_zip_folder_20240331',
...
LOCAL_DESTINATION = '/source-biakonzasftp/L-248/HL7v2_NJ_202403/' #PRD is '/source-biakonzasftp/C-9/optout_load/' #DEV is '/source-biakonzasftp/L-215/'
...
start_date = datetime(2024, 3, 31, 0, 0, 0)
end_date = datetime(2024, 3, 31, 0, 0, 0)
