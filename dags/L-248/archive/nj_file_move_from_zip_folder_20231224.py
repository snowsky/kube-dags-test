...
dag = DAG(
    'nj_file_move_from_zip_folder_20231224',
...
LOCAL_DESTINATION = '/source-biakonzasftp/L-248/HL7v2_NJ_202312/' #PRD is '/source-biakonzasftp/C-9/optout_load/' #DEV is '/source-biakonzasftp/L-215/'
...
start_date = datetime(2023, 12, 24, 0, 0, 0)
end_date = datetime(2023, 12, 24, 0, 0, 0)
