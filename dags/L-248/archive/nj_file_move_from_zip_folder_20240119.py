...
dag = DAG(
    'nj_file_move_from_zip_folder_20240119',
...
LOCAL_DESTINATION = '/source-biakonzasftp/L-248/HL7v2_NJ_202401/' #PRD is '/source-biakonzasftp/C-9/optout_load/' #DEV is '/source-biakonzasftp/L-215/'
...
start_date = datetime(2024, 1, 19, 0, 0, 0)
end_date = datetime(2024, 1, 19, 0, 0, 0)
