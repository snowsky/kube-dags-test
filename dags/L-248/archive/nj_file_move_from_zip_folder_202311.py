...
dag = DAG(
    'nj_file_move_from_zip_folder_202311',
...
LOCAL_DESTINATION = '/source-biakonzasftp/L-248/HL7v2_NJ_202311/' #PRD is '/source-biakonzasftp/C-9/optout_load/' #DEV is '/data/biakonzasftp/L-215/'
...
end_date = datetime(2023, 11, 30, 0, 0, 0)
