...
dag = DAG(
    'nj_file_move_from_zip_folder_202307',
...
LOCAL_DESTINATION = '/source-biakonzasftp/L-248/HL7v2_NJ_202307/' #PRD is '/source-biakonzasftp/C-9/optout_load/' #DEV is '/data/biakonzasftp/L-215/'
...
end_date = datetime(2023, 7, 31, 0, 0, 0)
