...
dag = DAG(
    'nj_file_move_from_zip_folder_202405',
...
LOCAL_DESTINATION = '/source-biakonzasftp/L-248/HL7v2_NJ_202405/' #PRD is '/source-biakonzasftp/C-9/optout_load/' #DEV is '/data/biakonzasftp/L-215/'
...
end_date = datetime(2024, 5, 31, 0, 0, 0)
