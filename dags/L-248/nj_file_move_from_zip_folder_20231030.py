...
dag = DAG(
    'nj_file_move_from_zip_folder_20231030',
...
LOCAL_DESTINATION = '/source-biakonzasftp/L-248/HL7v2_NJ_202310/' #PRD is '/source-biakonzasftp/C-9/optout_load/' #DEV is '/source-biakonzasftp/L-215/'
...
start_date = datetime(2023, 10, 30, 0, 0, 0)
end_date = datetime(2023, 10, 30, 0, 0, 0)
