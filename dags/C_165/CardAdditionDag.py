...
from lib.wekan.controllers.cards import create_card, edit_card_data, edit_card_custom_field
...
with DAG(
    ...
    def _extract_results_into_support_tickets(
        ...
        for row in results:
            ...
            project_ids = set([val for val in [project_id, project_id_other] if (val.startswith('L-') or val.startswith('S-') or val.startswith('C-'))])
