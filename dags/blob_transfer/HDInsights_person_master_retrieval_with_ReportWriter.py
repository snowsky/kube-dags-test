...
def transfer_blob_hook_uri():
    ...
    conn_source_str = get_conn_string("hdinsightstorageaccount-blob-core-windows-net")
    conn_destination_str = get_conn_string("reportwriterstorage-blob-core-windows-net")
    transfer_blob(conn_source_str, conn_destination_str, "parquet-master-data", "content")#"content/parquet-master-data"
